            ...
            for keyword in keywords:
                ...
                for result in data.get('results', []):
                    ...
                    job = {
                        ...
                        'salary_min': int(result.get('salary_min', 600000)) if (result.get('salary_min') and int(result.get('salary_min')) > 10000) else 600000,
                        'salary_max': int(result.get('salary_max', 1200000)) if (result.get('salary_max') and int(result.get('salary_max')) > 10000) else 1200000,
                        'currency': 'INR',
                        'source': 'Adzuna',
